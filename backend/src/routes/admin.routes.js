...
router.post('/orders/:id/refund/approve', authMiddleware, requireRole('admin'), adminController.approveRefundRequest);
router.post('/orders/:id/refund/reject', authMiddleware, requireRole('admin'), adminController.rejectRefundRequest);
